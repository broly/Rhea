...
const uint COLOR_OUTPUT_HDR_RESERVED_0 = 4;
const uint COLOR_OUTPUT_HDR_RTXGI_REPROJECTED = 5;
const uint COLOR_OUTPUT_HDR_RTXGI_ACCUM = 6;
const uint COLOR_OUTPUT_HDR_RTXGI_MOMENTS = 7;
const uint COLOR_OUTPUT_HDR_RTXGI_FILTERED = 8;
const uint COLOR_OUTPUT_HDR_RTXGI_NEURAL_DENOISED = 9;
const uint COLOR_OUTPUT_HDR_RESERVED_1 = 10;
