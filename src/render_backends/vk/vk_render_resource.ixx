...
public:
    ...
    virtual std::shared_ptr<RenderResourceInstance> query_single(uint32_t instance_id) override;
    virtual std::shared_ptr<RenderResourceInstance> query_unique(uint32_t unique_id, uint32_t instance_id) override;
